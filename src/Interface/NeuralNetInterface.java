...
public interface NeuralNetInterface extends CommonInterface{
     ...
     * @param argLearningRate The learning rate coefficient 17 * @param argMomentumTerm The momentum coefficient
    ...
    */
    ...
    /**
     * Return a bipolar sigmoid of the input X 32 * @param x The input
     * @return f(x) = 2 / (1+e(-x)) - 1 34
     */
